...
export const dict = {
  ...
  "kilocode:autocomplete.toggleMessage": "Sober Code Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "Sober Code",
  ...
  "kilocode:autocomplete.commands.category": "Sober Code",
  "kilocode:autocomplete.codeAction.title": "Sober Code: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "Sober Code Agent",
